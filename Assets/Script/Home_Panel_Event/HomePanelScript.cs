...
*/
  ...
  消息显示隐藏
    ...
    public void openGameSettingDialog()
    {
        ...
        // SettingScript.jiesanBtn.GetComponentInChildren<Text>().text = "退出游戏";
        SettingScript.type = 1;
    }
    // End
	...
	*/
    ...
    public void ExitFun()
    {
        loadPerfab("Prefab/Panel_Exit");
    }
    public void ProxyOpenFun()
    {
        proxyPanel.SetActive(true);
    }
    public void ProxyCloseFun()
    {
