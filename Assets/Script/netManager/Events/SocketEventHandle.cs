...
namespace AssemblyCSharp
{
    ...
    public class SocketEventHandle : MonoBehaviour
    {
        ...
        //俱乐部回调
        public ServerCallBackEvent CreateClubCallBack;//创建俱乐部回调
        public ServerCallBackEvent JoinClubCallBack;//加入俱乐部回调
        public ServerCallBackEvent GetApplyClubCallBack;//获取申请列表回调
        public ServerCallBackEvent GetAllClubCallBack;////获取俱乐部成员
        public ServerCallBackEvent AgreeClubCallBack;////同意俱乐部成员
        public ServerCallBackEvent ClubStateCallBack;////俱乐部状态
        public ServerCallBackEvent QuitClubCallBack;////退出俱乐部
        ...
        private void dispatchHandle(ClientResponse response)
        {
            switch (response.headCode)
            {
                ...
                case APIS.CREATEROOM_RESPONSE:
                    ...
                    break;
                case APIS.CREATE_CLUB_RESPONSE: // 创建俱乐部回调
                    if (CreateClubCallBack != null)
                    {
                ...
                case APIS.CHEAT_Response:
                    ...
                    break;
                case APIS.JOIN_CLUB_RESPONSE:
                    if (JoinClubCallBack != null)
                    {
                        JoinClubCallBack(response);
                    }
                    break;
                case APIS.GETALL_CLUB_RESPONSE:
                    if (GetAllClubCallBack != null)
                    {
                        GetAllClubCallBack(response);
                    }
                    break;
                case APIS.GETAPPLY_CLUB_RESPONSE:
                    if (GetApplyClubCallBack != null)
                    {
                        GetApplyClubCallBack(response);
                    }
                    break;
                case APIS.AGREE_CLUB_RESPONSE:
                    if (AgreeClubCallBack != null)
                    {
                        AgreeClubCallBack(response);
                    }
                    break;
                case APIS.CLUBSTATE_RESPONSE:
                    if (ClubStateCallBack != null)
                    {
                        ClubStateCallBack(response);
                    }
                    break;
                case APIS.QUIT_CLUB_RESPONSE:
                    if (QuitClubCallBack != null)
                    {
                        QuitClubCallBack(response);
                    }
                    break;
            }
