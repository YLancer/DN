...
namespace AssemblyCSharp
{
    ...
    public class APIS
    {
        ...
        //public static string baseUrl = "http://skyl.shenkongjian.com";
        public static string baseUrl = "103.26.79.31";
        //public static string baseUrl = "211.149.217.49";
        ...
        //public static string chatSocketUrl = "127.0.0.1";
        //public static string socketUrl = "127.0.0.1";

        public static string chatSocketUrl = "103.26.79.31"; 
        public static string socketUrl = "103.26.79.31";

        //public static string chatSocketUrl = "211.149.217.49";
        //public static string socketUrl = "211.149.217.49";
        ...
        // Add by Shise  mark
        // public const int QIANGBEI_DN_REQUEST = 0xba;
        // End
        ...
        // Add by Lingting
        //俱乐部
        public const int CREATE_CLUB_REQUEST = 0x510001;//创建俱乐部
        public const int CREATE_CLUB_RESPONSE = 0x510003;
        public const int JOIN_CLUB_REQUEST = 0x510002;//加入俱乐部
        public const int JOIN_CLUB_RESPONSE = 0x510004;
        public const int GETAPPLY_CLUB_REQUEST = 0x510005;//获取申请俱乐部列表 请求参数为空
        public const int GETAPPLY_CLUB_RESPONSE = 0x510006;
        public const int GETALL_CLUB_REQUEST = 0x510007;//获取俱乐部成员
        public const int GETALL_CLUB_RESPONSE = 0x510008;
        public const int AGREE_CLUB_REQUEST = 0x510009;//操作同意或拒绝加入
        public const int AGREE_CLUB_RESPONSE = 0x510010;
        public const int CLUBSTATE_REQUEST = 0x510011;//获取俱乐部信息
        public const int CLUBSTATE_RESPONSE = 0x510012;
        public const int QUIT_CLUB_REQUEST = 0x510015;//退出俱乐部
        public const int QUIT_CLUB_RESPONSE = 0x510016;
        // End
    }
