...
public class PlayerItemScript : MonoBehaviour
{
	...
	public void setNiuImg(int niu){
        ...
        // Add by Shise
        SoundCtrl.getInstance().playSoundByNiu(niu, avatarvo.account.sex);
        // End
    }
...
//		scoreText.text = int.Parse("scoreText.text") + score + "";
	...
	private Vector3 getZhuCoinPosition(int i){
		...
		switch (i) {
		case 0:
			vec = new Vector3 (55, 67, 0);
			break;
		case 1:
			vec = new Vector3 (64, 62.6f, 0);
			break;
		case 2:
			vec = new Vector3 (71, 60, 0);
			break;
		case 3:
			vec = new Vector3 (70, 57.4f, 0);
			break;
		case 4:
			vec = new Vector3 (-45, 58, 0);
			break;
		case 5:
			vec = new Vector3 (-55, 55.5f, 0);
			break;
		default:
			break;
		}
    ...
    void ShowOrDisShowHeadImage(int value)
    {
        yuanColor = this.gameObject.GetComponent<Image>().color;
        yuanColor.a = value;
        this.gameObject.GetComponent<Image>().color = yuanColor;
    }
}
